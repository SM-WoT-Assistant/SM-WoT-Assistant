...
├── admin_version.txt           # Plaintext semver for Admin Desktop App (1.0.7) — independent of main VERSION; read by admin_app.py and build_admin.py, bundled via --add-data
