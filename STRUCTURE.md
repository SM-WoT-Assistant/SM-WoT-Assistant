...
```
[project-root]/
├── main.py                     # Application entry point, WotAssistantHQ hub class, single-instance mutex, splash update check, CLI --ai-webview routing, F10 closes drawing palette
