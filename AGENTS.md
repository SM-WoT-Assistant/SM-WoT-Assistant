...
1. **На початку сесії:** обов'язково виконати `ctx_memory(action="list")`, перевірити чи плагін працює, повідомити користувачу статус ("🧠 Пам'ять: OK" або "⚠️ Плагін не відповідає").
